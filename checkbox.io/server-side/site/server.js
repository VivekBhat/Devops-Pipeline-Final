...
var client = redis.createClient(6379, 'redis_slave', {})
...
// app.get('/api/feature/:feature', study.feature);

app.get('/api/view/:feature', function(req, res) {
    res.writeHead(200, {
...
app.get('/api/listfeatures', function(req, res) {
...
app.get('/api/ports', function (req, res) {
	{
		client.lrange("serverlist", 0, -1, function (err, items) {
			if (err) throw err
