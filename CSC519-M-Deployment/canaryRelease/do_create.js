...
var servers = ['AppServer', 'CanaryServer'];
            ...
            client.createInventory(data.droplet.id, function(err, resp) {
                ...
                if (res_data.droplet.id) {
                    ...
                    if (dropletName === 'RedisServer') {
                        ...
                        fs.writeFile('ansible/redis.json', JSON.stringify(redisDetails), function(err) {
                            if (err) throw err;
                ...
                fs.writeFile('ansible/inventory', inventoryContent, function(err) {
                    if (err) throw err;
