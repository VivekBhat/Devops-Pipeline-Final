...
var client = {
    ...
    listDroplets: function(onResponse){
        needle.get('https://api.digitalocean.com/v2/droplets', {headers:headers, json:true}, onResponse);
    },
    deleteDroplet: function(dID, onResponse){
        needle.delete('https://api.digitalocean.com/v2/droplets/'+ dID, null, {headers:headers, json:true}, onResponse);
    },
